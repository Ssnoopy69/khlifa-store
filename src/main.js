...
document.addEventListener("DOMContentLoaded", function () {
    ...
    randomProducts.forEach((product) => {
        ...
        productDiv.innerHTML = `
            <div id="model-${product.id}" class="model-container" style="width: 200px; height: 200px;"></div>
        ...
        console.log(`Loading model for product: components/models/${product.model}`);
        loader.load(
            ...
            function (gltf) {
                ...
                productRenderer.setSize(productContainer.clientWidth, productContainer.clientHeight);
                ...
                window.addEventListener("resize", () => {
                    productCamera.aspect = productContainer.clientWidth / productContainer.clientHeight;
    ...
    // Initialize the product slider using tiny-slider
    const slider = tns({
